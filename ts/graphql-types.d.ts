...
export type SiteMetadataQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };

export type GuideQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type GuideQueryQuery = { mdx?: Maybe<Pick<Mdx, 'body' | 'tableOfContents'>> };

export type IndexSliderImagesQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexSliderImagesQueryQuery = { images: { nodes: Array<(
      Pick<File, 'id'>
...
export type Unnamed_1_Query = { pavel?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, vasko?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, lyubo?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, vlado?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
